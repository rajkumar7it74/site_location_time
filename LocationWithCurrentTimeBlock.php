...
use Drupal\site_location_time\Services\CurrentTime;
...
class LocationWithCurrentTimeBlock extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @var \Drupal\site_location_time\Services\CurrentTime
   */
   ...
   * @param Drupal\site_location_time\Services\CurrentTime $currenttimeService
   *   The current time service.
   */
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_definition,
        ...
        $container->get('site_location_time.current_time')
    );
  }
  ...
  public function build() {
    ...
    $build = [
      '#theme' => 'location_current_time_block',
  ...
  public function getCacheMaxAge() {
    ...
    // never cache this block, so I am setting max-age to 1 second.
    return 1;
  }
